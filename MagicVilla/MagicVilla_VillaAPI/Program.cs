...
//builder.Services.AddSingleton<ILogging, Logging>();    // this is added for custom Logging
//builder.Services.AddSingleton<ILogging, LoggingV2>();    // this is added for custom Logging
